...
public class ViewK200CurrencyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_k200_currency);
        ...
        Bitmap finalBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.k200_front);
    ...
    private void showBanknoteAndDrawRegions(Bitmap rawBitmap) {
        ...
        if (isFront) {
            ...
            rectCanvas.drawRectangle(50, 130, 150, 270, finalBitmap);
            rectCanvas.drawRectangle(600, 470, 500, 300, finalBitmap);
        } else {
            rectCanvas.drawRectangle(910, 100, 60, 670, finalBitmap);
    ...
    private void showBanknoteSecurityRegions() {
        ...
        if (isFront) {
            layouts = new int[]{
                    R.layout.k200_front_security_2,
                    R.layout.k200_front_security_3,
                    R.layout.k200_front_security_4,
                    R.layout.k200_front_security_1};
        } else {
            layouts = new int[]{
                    R.layout.k200_back_security_1,
                    R.layout.k200_back_security_2,
                    R.layout.k200_back_security_3};
        }
    ...
    private void flipCurrency() {
        if (isFront) {
            isFront = false;
            Bitmap finalBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.k200_back);
            showBanknoteAndDrawRegions(finalBitmap);
