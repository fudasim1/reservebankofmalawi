...
public class ViewK100CurrencyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_k100_currency);
        ...
        Bitmap finalBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.k100_front);
    ...
    private void showBanknoteAndDrawRegions(Bitmap rawBitmap) {
        ...
        if (isFront) {
            ...
            rectCanvas.drawRectangle(960, 100, 100, 670, finalBitmap);
            rectCanvas.drawRectangle(1200, 120, 300, 470, finalBitmap);
            rectCanvas.drawRectangle(40, 30, 240, 120, finalBitmap);
        }
    ...
    private void showBanknoteSecurityRegions() {
        ...
        if (isFront) {
            layouts = new int[]{
                    R.layout.k100_front_security_1,
                    R.layout.k100_front_security_2};
        } else {
            layouts = new int[]{
                    R.layout.k100_back_security_1,
                    R.layout.k100_back_security_2,
                    R.layout.k100_back_security_3};
        }
    ...
    private void flipCurrency() {
        if (isFront) {
            isFront = false;
            Bitmap finalBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.k100_back);
            showBanknoteAndDrawRegions(finalBitmap);
