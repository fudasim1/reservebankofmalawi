...
public class ViewK500CurrencyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_k500_currency);
        ...
        Bitmap finalBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.k500_front);
    ...
    private void showBanknoteAndDrawRegions(Bitmap rawBitmap) {
        ...
        if (isFront) {
            ...
            rectCanvas.drawRectangle(60, 120, 140, 270, finalBitmap);
            rectCanvas.drawRectangle(610, 470, 500, 300, finalBitmap);
        } else {
            rectCanvas.drawRectangle(965, 100, 60, 670, finalBitmap);
            rectCanvas.drawRectangle(1200, 120, 300, 470, finalBitmap);
            rectCanvas.drawRectangle(60, 50, 240, 110, finalBitmap);
        }
    ...
    private void showBanknoteSecurityRegions() {
        ...
        if (isFront) {
            layouts = new int[]{
                    R.layout.k500_front_security_2,
                    R.layout.k500_front_security_3,
                    R.layout.k500_front_security_4,
                    R.layout.k500_front_security_1};
        } else {
            layouts = new int[]{
                    R.layout.k500_back_security_1,
                    R.layout.k500_back_security_2,
                    R.layout.k500_back_security_3};
        }
    ...
    private void flipCurrency() {
        if (isFront) {
            isFront = false;
            Bitmap finalBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.k500_back);
            showBanknoteAndDrawRegions(finalBitmap);
