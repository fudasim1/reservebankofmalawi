...
public class ViewK50CurrencyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_k50_currency);
        ...
        Bitmap finalBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.k50_front);
    ...
    private void isFlipCurrency() {
        if (!isFlippedFront) {
            ...
            Bitmap finalBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.k50_back);
            showBanknoteAndDrawRegions(finalBitmap);
