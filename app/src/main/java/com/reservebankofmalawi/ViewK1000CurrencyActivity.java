...
public class ViewK1000CurrencyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_k1000_currency);
        ...
        Bitmap finalBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.k1000_front);
    ...
    private void showBanknoteAndDrawRegions(Bitmap rawBitmap) {
        ...
        if (isFront) {
            rectCanvas.drawRectangle(1445, 120, 120, 650, finalBitmap);
            rectCanvas.drawRectangle(240, 550, 280, 230, finalBitmap);
            rectCanvas.drawRectangle(220, 160, 250, 310, finalBitmap);
            rectCanvas.drawRectangle(610, 470, 500, 300, finalBitmap);
        }else{
            rectCanvas.drawRectangle(965, 100, 70, 670, finalBitmap);
            rectCanvas.drawRectangle(1200, 120, 300, 470, finalBitmap);
            rectCanvas.drawRectangle(70, 40, 250, 110, finalBitmap);
        }
    ...
    private void showBanknoteSecurityRegions() {
        ...
        if (isFront) {
            layouts = new int[]{
                    R.layout.k1000_front_security_3,
                    R.layout.k1000_front_security_2,
                    R.layout.k1000_front_security_4,
                    R.layout.k1000_front_security_1};
        }else{
            layouts = new int[]{
                    R.layout.k1000_back_security_1,
                    R.layout.k1000_back_security_2,
                    R.layout.k1000_back_security_3};
        }
    ...
    private void flipCurrency() {
        if (isFront) {
            isFront = false;
            Bitmap finalBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.k1000_back);
            showBanknoteAndDrawRegions(finalBitmap);
